    ...
    <body>    
        ...
        <div class="container" style="min-height:100vh">
            ...
            <div class="col d-flex justify-content-center"><div class="card" style="display: inline-block;">
                    ...
                    <div class="container">
                        <form class="needs-validation"  id="form-register" method="POST" action="/cadastro_compradores">
                            <div class="text-center"><h2>Cadastro de Comprador</h2></div>
                            <!--Nome-->
                            ...
                            <!--Botão-->
                            <div class="form-group">
                                    <button class="btn btn-dark btn-block" data-toggle="modal" type="submit">Cadastrar Comprador</button>
                            </div>
