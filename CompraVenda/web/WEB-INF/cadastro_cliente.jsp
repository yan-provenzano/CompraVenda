            ...
            <div class="col d-flex justify-content-center"><div class="card" style="display: inline-block;">
                    ...
                    <div class="container">
                        <form class="needs-validation"  id="form-register" method="POST" action="/cadastro_cliente">
                            <div class="text-center"><h2>Cadastro de Clientes</h2></div>
                            <!--Nome-->
                            <div class="form-group">
                                <label for="firstName" class="col control-label">Nome:</label>
                                <input type="text" required="required" name="nome" minlength="3" maxlength="50"placeholder="Nome Completo" class="form-control" autofocus>
                            </div>
                            <!--CPF-->
                            <div class="form-group">
                                <label for="cpf">CPF:</label>
                                <input type="text" required="required" minlength="11" maxlength="14" name="cpf" placeholder="XXX.XXX.XXX-XX" class="form-control" autofocus>
                            </div>
                            <!--Bloco de endereço-->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" required="required" minlength="3" maxlength="50" name="email" placeholder="nome@exemplo.com" class="form-control" autofocus>
                            </div>
                            <!--Botão-->
                            <div class="form-group">
