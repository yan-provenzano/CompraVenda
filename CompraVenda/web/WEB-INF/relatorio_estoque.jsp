<%-- 
    Document   : Lista Produtos para ADMIN
        ...
        <div class="container" style="min-height:100vh">
            <div class="row">
                <table class="table table-striped table-responsive">
                    ...
                    <tbody>
                        <% List<Produtos> produtos = (List<Produtos>) request.getAttribute("relatorio_estoque");
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-dark" role="button"  href="/administrador/adm_editar_produto?id=<%=a.getId()%>" >Editar</a>
                                </div>
                            </td>  
                        </tr>
                        <% }%>
