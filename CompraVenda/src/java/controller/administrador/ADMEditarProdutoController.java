 ...
 * @author Isaac
 */
@WebServlet("/administrador/adm_editar_produto")
public class ADMEditarProdutoController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/administrador/adm_editar_produto.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (user.getTipoUsuario().equals(TipoUsuario.ADMIN)) {
            resp.sendRedirect("/relatorio_estoque");
        }
    }
}
